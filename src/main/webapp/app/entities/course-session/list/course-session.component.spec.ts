...
describe('Component Tests', () => {
  describe('CourseSession Management Component', () => {
    let comp: CourseSessionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseSessionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseSessions?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
