...
describe('Component Tests', () => {
  describe('CourseLevel Management Component', () => {
    let comp: CourseLevelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseLevelComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseLevels?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
