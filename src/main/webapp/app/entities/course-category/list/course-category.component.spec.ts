...
describe('Component Tests', () => {
  describe('CourseCategory Management Component', () => {
    let comp: CourseCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseCategories?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
