...
export class CourseEnrollmentComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.courseEnrollmentService
      ...
      .subscribe(
        (res: HttpResponse<ICourseEnrollment[]>) => {
  ...
  trackId(index: number, item: ICourseEnrollment): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICourseEnrollment[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
