...
export class CourseProgressComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.courseProgressService
      ...
      .subscribe(
        (res: HttpResponse<ICourseProgress[]>) => {
  ...
  trackId(index: number, item: ICourseProgress): number {
    return item.id!;
  }

  delete(courseProgress: ICourseProgress): void {
    const modalRef = this.modalService.open(CourseProgressDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ICourseProgress[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
